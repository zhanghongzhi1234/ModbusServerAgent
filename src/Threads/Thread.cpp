...
namespace TA_Base_Core
{
	...
	static void* runThread(void* ptr)
	{
		...
		myThread->run();
/*  no need to catch and then assert which will mess up the real stack of the faulty thread, and causes even harder to locate the problem. 
        try
        {
		    myThread->run();
        }
